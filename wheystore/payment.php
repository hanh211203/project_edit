...
<html>
	...
	<head>
		...
		<!-- Title -->
		<title>WHEY STORE - Chất Lượng và dịch vụ chuyên nghiệp</title>
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="images/wheystoreicon.png" type="image/x-icon" />
		...
		<div class="main-body-wrapper">
			...
			<section class="main-content-wrapper clearfix">
				...
				<div class="main-header">
					<div class="logo">
						<a href="index.php" class="logo-blank custom-font-1"><span> WHEY STORE</span></a>

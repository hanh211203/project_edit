...
<div class="box1 col-md-6 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
     <div class="container">
      ...
      ?>
            <form method="post" enctype="multipart/form-data" action="?controller=user&redirect=product&action=update">
        ...
        <div class="box1 col-lg-6">
            ...
            <div class="mb-3">
                ...
                <textarea name="recommended_use" id="recommended_use" cols="30" row="20" value="<?= $item['recommended_use']?>"></textarea>
            </div>
            <div class="mb-3">
